---
description: Initialize APM Setup Agent – gather requirements and create Implementation Plan for a new APM session.
---
...
**Your options:**
- **Plan looks good** → Setup Phase is complete. Proceed to initialize Manager Agent using `/apm.manager`.
...
**Setup Phase is complete.** Proceed to initialize Manager Agent using `/apm.manager`."
