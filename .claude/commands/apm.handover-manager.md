---
description: Execute APM Manager Agent handover procedure – transfer project coordination context to a new Manager Agent instance when approaching context window limits.
---
...
2. Initialize a new Manager Agent instance using `/apm.manager`
